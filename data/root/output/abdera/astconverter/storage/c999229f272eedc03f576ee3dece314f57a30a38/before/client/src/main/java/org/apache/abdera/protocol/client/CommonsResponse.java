    ...
    public isClassOrInterfaceInstantiation isMethod() throws isClassOrInterfaceInstantiation {
        if (isNameExpr == null) {
            ...
            if (isNameExpr != null) {
                // isComment
                // isComment
                isClassOrInterfaceInstantiation[] isVariable = isNameExpr.isMethod(isNameExpr, "isStringConstant", true);
                for (int isVariable = isNameExpr.isFieldAccessExpr - isIntegerConstant; isNameExpr >= isIntegerConstant; isNameExpr--) {
                    if ("isStringConstant".isMethod(isNameExpr[isNameExpr]) || "isStringConstant".isMethod(isNameExpr[isNameExpr])) {
                        isNameExpr = new isClassOrInterfaceInstantiation(isNameExpr);
                    } else if ("isStringConstant".isMethod(isNameExpr[isNameExpr])) {
                        isNameExpr = new isClassOrInterfaceInstantiation(isNameExpr);
                    } else if ("isStringConstant".isMethod(isNameExpr[isNameExpr])) {
                        isNameExpr = new isClassOrInterfaceInstantiation(isNameExpr);
                    } else {
